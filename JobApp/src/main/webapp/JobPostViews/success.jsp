...
<%@ page import="com.job.model.JobModel" %>
...
<%
	JobModel myJobPost = (JobModel)request.getAttribute("jobPost");
%>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card border-dark bg-dark text-white">
                <div class="card-body">
                    <h5 class="card-title">${myJobPost.postProfile}</h5>
                    <p class="card-text">
